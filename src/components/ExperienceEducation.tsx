...
import { ResearchPaperArticle } from './ResearchPaperArticle';
import { Briefcase, GraduationCap, Calendar, MapPin, CheckCircle } from 'lucide-react';

export const ExperienceEducation: React.FC = () => {
  return (
    <section id="experience" className="py-24 border-b border-slate-200/80 bg-slate-50/60 dark:border-slate-800/60 dark:bg-slate-900/40 transition-colors duration-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="pb-10 border-b border-slate-200 dark:border-slate-800/80">
          <div className="flex items-center gap-2 mb-1">
            ...
            <ReadingTimeBadge targetId="experience" defaultMinutes={4} />
          </div>
          ...
          <p className="mt-2 text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-2xl">
            My professional software engineering internship, formal Computer Science degree, and peer-reviewed IEEE research publication.
          </p>
        </div>

        {/* In-Depth Research Article with Granular Reading Progress Indicator */}
            ...
            <div className="space-y-6">
              {EXPERIENCE_DATA.map((exp, idx) => (
                <motion.div
                  ...
                  className="rounded-2xl border border-slate-200 bg-white p-6 transition-colors hover:border-indigo-200 hover:shadow-md dark:border-slate-800 dark:bg-slate-900/60 dark:hover:border-indigo-500/30"
                >
