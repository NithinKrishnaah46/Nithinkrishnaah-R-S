        ...
        >
          {navLinks.map((link) => (
            <a
              ...
              className="transition-colors hover:text-slate-900 dark:hover:text-white hover:underline underline-offset-4 decoration-indigo-500/60"
            >
              {link.name}
            </a>
          ))}
        ...
        >
          ...
          <div className="mt-4 flex items-center justify-between border-t border-slate-200 pt-4 dark:border-slate-800/80">
            <div className="flex items-center gap-4">
              ...
              >
                <Github className="h-4 w-4 text-indigo-500 dark:text-indigo-400" />
                <span>GitHub</span>
              </a>
              <a
                href={PERSONAL_INFO.socials.linkedin}
                ...
                className="flex items-center gap-1.5 text-xs font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white"
              >
                <Linkedin className="h-4 w-4 text-indigo-500 dark:text-indigo-400" />
                <span>LinkedIn</span>
              </a>
              <a
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300"
            >
              {theme === 'dark' ? (
                <>
                  <Sun className="h-3.5 w-3.5 text-amber-400" />
